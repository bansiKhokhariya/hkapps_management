...
class TaskReWorkingNotification extends Notification
{
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'message' =>$this->task_details['app_no'].' - '.$this->task_details['task_title'].' is given for re-working'.' by '.$this->auth_user->name.'.',
        ];
    }
