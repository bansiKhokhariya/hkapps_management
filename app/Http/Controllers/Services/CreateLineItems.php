...
class CreateLineItems
{
    ...
    const ORDER_ID = '3193004120';
    const PLACEMENT_ID = '31458476';
...
//        $creativePlaceholder->setSize(new Size(300, 250, false));
        ...
        foreach ($sizes as $size) {
            $creativePlaceholderSize = new Size();
            $creativePlaceholderSize->setWidth($size['width']);
            $creativePlaceholderSize->setHeight($size['height']);
            $creativePlaceholderSizes[] = $creativePlaceholderSize;
        }
        $creativePlaceholder->setSize($creativePlaceholderSizes);
        ...
        $lineItem->setWebPropertyCode('ca-mb-app-pub-1912126281370351');
